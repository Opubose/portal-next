...
interface ScoreboardResetDialogProps {
  isOpen: boolean;
  confirmInput: string;
...
export default function ScoreboardResetDialog({
  isOpen,
  confirmInput,
  onConfirmInputChange,
  onResetConfirm,
  closeModal,
}: ScoreboardResetDialogProps) {
  return (
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="my-6">
                  <p className="text-sm text-gray-500">
                    Are you sure you want to reset the scoreboard? This action cannot be undone. To
                    confirm reset, please type CONFIRM RESET in the box below and click Reset.
                  </p>
                  <input
                    type="text"
                    value={confirmInput}
                    className="p-3 rounded-lg"
                    placeholder="Enter CONFIRM RESET here"
